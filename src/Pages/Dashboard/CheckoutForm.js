...
const CheckoutForm = ({ order }) => {
    ...
    useEffect(() => {
        fetch(`https://fierce-wildwood-20183.herokuapp.com/create-payment-intent`, {
            method: 'POST',
            headers: {
        ...
        <div>
            ...
            }
            {
                success && <div className='text-green-500'>
                    <p>{success}  </p>
                    <p>Your transaction Id: <span className="text-black-500 font-bold">{transactionId}</span> </p>
                </div>
            }
        </div>
    );
